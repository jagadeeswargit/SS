...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    query = name
    myResponse,id = semanticSearchQA(query)
    return func.HttpResponse(f"Answer is : {myResponse}. Id is : {id}.")
...
def semanticSearchQA(query):   
    ...
    query_with_contexts,responseId = retrieve(query,embed_model,index)
    return complete(query_with_contexts),responseId